...
export * from "./behavioral-evidence";
...
const FIELD_KIT_TOOL_DEFINITIONS: FieldKitTool[] = [
  ...
  },
  {
    ...
    howSteps: [
      ...
      "Build the decision brief and take one clear objective into the room",
    ],
    ...
    outcome: "A sourced provider profile, evidence coverage, focused meeting objective, decision plan, and a clear next move.",
  },
  {
    id: "playbooks",
    owner: "explore",

...
export const mambaDark = {
  ...
  destructive: "#D13B4A",
  destructiveForeground: "#FFFFFF",
  border: "rgba(253, 185, 39, 0.38)",
  borderStrong: "rgba(253, 185, 39, 0.68)",
  input: "#241536",
...
export const mambaLight = {
  ...
  primary: "#552583",
  primaryForeground: "#D4D4D4",
  primaryMuted: "rgba(85, 37, 131, 0.18)",
  secondary: "#FDB927",
  secondaryForeground: "#1A1A1A",
  muted: "#E7D9F1",
  ...
  destructive: "#B82036",
  destructiveForeground: "#FFFFFF",
  border: "rgba(85, 37, 131, 0.32)",
  borderStrong: "rgba(85, 37, 131, 0.56)",
  input: "#F7F7F7",
  heroBackground: "#1A1A1A",
  heroForeground: "#D4D4D4",
  heroMuted: "#D4D4D4",

...
export const HSP_DOMAIN_OBJECTS: readonly DomainObjectSpec[] = [
  ...
  },
  {
    ...
    storage: "not_modeled",
    location: "branch-engine calculator inputs only",
    tenantKey: "none",
    forbidParallelTable: false,
    notes: "Slice C candidate if product needs persistent branches.",
  },
  {
    id: "team",
    title: "Team",
    storage: "not_modeled",
    location: "workflow Actor.teamIds unused in product auth",
    tenantKey: "none",
    forbidParallelTable: false,
    notes: "Slice C candidate; do not invent until org_admin UX exists.",
  },
  {
    id: "territory",
    title: "Territory",

      ...
      >
        {!q ? (
          <View style={styles.destinationGrid} testID="explore-destinations">
            <ExploreDestination icon="crosshair" title="CMS Medicare Knowledge Hub" body={canUseElite ? "Verify providers, analyze markets, build decisions, and prepare with Coach." : "Elite provider, market, decision, and CMS policy intelligence."} onPress={() => router.push((canUseElite ? "/spartan-intelligence" : "/access") as any)} />

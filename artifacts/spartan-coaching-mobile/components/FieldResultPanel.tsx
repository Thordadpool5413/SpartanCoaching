...
const styles = StyleSheet.create({
  ...
  hero: { paddingHorizontal: 22, paddingTop: 22, paddingBottom: 20 },
  kicker: { fontSize: 9, letterSpacing: 1.8, marginBottom: 10 },
  title: { fontSize: 23, lineHeight: 28, letterSpacing: -0.35 },
  trustRow: { flexDirection: "row", alignItems: "flex-start", gap: 10, marginTop: 18 },
  trustCopy: { flex: 1 },
  ...
  resultBody: { paddingHorizontal: 22, paddingVertical: 26, gap: 20 },
  sectionHeader: { flexDirection: "row", alignItems: "center", gap: 12, marginTop: 18, marginBottom: 2 },
  ...
  itemText: { flex: 1, fontSize: 14, lineHeight: 23 },
  footer: { marginHorizontal: 22, borderTopWidth: StyleSheet.hairlineWidth, paddingVertical: 18, gap: 6 },

...
function makeStyles(colors: ReturnType<typeof useColors>) {
  ...
  return StyleSheet.create({
    ...
    section: { borderRadius: 18, borderCurve: "continuous", borderWidth: 1, borderColor: colors.borderStrong, backgroundColor: colors.card, paddingHorizontal: 18, paddingVertical: 20, gap: 18 },
    ...
    valueText: { color: colors.foreground, fontSize: 15, lineHeight: 24, ...font("regular") },
    ...
    bulletText: { flex: 1, color: colors.foreground, fontSize: 14, lineHeight: 22, ...font("regular") },
    objectStack: { gap: 18 },
    ...
    deepRow: { borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: colors.border, paddingTop: 14 },
    emailStack: { gap: 14 },
    ...
    childLabel: { color: colors.mutedForeground, fontSize: 10, lineHeight: 15, letterSpacing: 0.7, textTransform: "uppercase", marginBottom: 8, ...font("bold") },
  });
}

    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center">
        <div className="overflow-hidden mb-[1vh]">
          <motion.h1
            className="font-sans font-medium text-[4vw] tracking-[0.2em] text-[var(--color-brand-warm)] text-shadow-subtle uppercase"
        ...
        <div className="overflow-hidden">
          <motion.h2
            className="font-display font-semibold italic text-[8vw] leading-none text-[var(--color-brand-white)] text-shadow-heavy"
            initial={{ y: "100%", opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
      ...
      {/* Subtle line accent */}
      <motion.div
        className="absolute bottom-[20vh] w-[1px] h-[10vh] bg-gradient-to-b from-white/50 to-transparent"

...
export function Scene2_Stats() {
  ...
  return (
    ...
    >
      ...
      {/* Phase 1: big number */}
      <motion.div className="absolute inset-0 flex flex-col items-center justify-center px-[8vw]" animate={vis(1)}>
        <motion.h2
        ...
        <motion.p
          className="font-body text-[#9a9a8e] uppercase tracking-widest mt-6 text-center"
          style={{ fontSize: 'clamp(20px, 3.5vw, 52px)', letterSpacing: '0.16em' }}
      ...
      {/* Phase 2: the loss */}
      <motion.div className="absolute inset-0 flex items-center px-[8vw]" animate={vis(2)}>
        <motion.h2
      ...
      <motion.div className="absolute inset-0 flex items-center px-[8vw]" animate={vis(3)}>
        <motion.h2
          className="font-display uppercase leading-[0.9]"
          style={{ fontSize: 'clamp(48px, 8.5vw, 140px)', color: '#9a9a8e' }}

  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        style={{ fontSize: 'clamp(20px, 3.5vw, 54px)', letterSpacing: '0.24em' }}
        initial={{ opacity: 0 }}
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center px-4 overflow-hidden" style={{ lineHeight: '0.85' }}>
        <motion.h1
          ...
          style={{ fontSize: phase >= 2 ? 'clamp(80px, 17vw, 270px)' : 'clamp(110px, 24vw, 380px)' }}
        ...
        <motion.h1
          className="font-display uppercase text-center w-full whitespace-nowrap overflow-hidden"
          style={{ fontSize: phase >= 3 ? 'clamp(80px, 17vw, 270px)' : 'clamp(96px, 21vw, 330px)' }}
        ...
        <motion.h1
          className="font-display uppercase text-center w-full whitespace-nowrap overflow-hidden"
          style={{ fontSize: 'clamp(80px, 17vw, 270px)', color: '#e8291e' }}

...
const seoDefaults: Record<string, SEOConfig> = {
  ...
  "/services": {
    ...
    keywords:
      "hospice sales coaching, Hospice Sales Pro, leadership coaching, consulting services",
  },
  "/programs": {
    ...
    keywords:
      "hospice training programs, sales team training, healthcare sales programs",
  },
  "/method": {
    ...
    keywords:
      "Spartan Method, sales methodology, hospice sales framework, Hospice Sales Pro",
  },
  "/tools": {
    ...
    keywords:
      "Hospice Sales Pro tools, sales playbooks, objection handling, territory research, AI coaching tools",
  },
  "/welcome": {
    title: "Welcome | Spartan Coaching",
    description:
      "Practical consulting and Hospice Sales Pro tools for hospice growth professionals.",
  ...
  "/request-access": {
    ...
    keywords:
      "Hospice Sales Pro team access, request evaluation, hospice sales tools, company seats, $14.99 week",
  },
  "/portal": {
    title: "Portal | Spartan Coaching",
    description:
      "Your Hospice Sales Pro portal, next action, tools, and resources.",
  ...
  "/account": {
    ...
    description:
      "Manage Hospice Sales Pro, choose recommended Elite at $19.99/week or Standard at $14.99/week, cancel anytime, and manage team seats.",
  ...
  "/hospice-sales-pro": {
    ...
    keywords:
      "Hospice Sales Pro, $14.99 week, hospice sales tools, team seats, cancel anytime",
  },
  ...
  "/pricing/field-kit": {
    ...
    keywords:
      "Hospice Sales Pro pricing, hospice consulting tools, $14.99 week",
  },
  "/tools/playbooks": {
    ...
    keywords:
      "sales playbook generator, hospice sales strategies, talking points",
    noIndex: true,
  },
  "/tools/objections": {
  ...
  "/resources/weekly-plan": {
    ...
    description:
      "Structure your hospice sales week with a proven action plan template.",
  ...
  "/resources/quick-start-guide": {
    ...
    description:
      "Hospice sales fundamentals, essential skills, processes, and best practices.",
    keywords: "quick start guide, hospice sales basics",
  },
  "/resources/objection-cards": {
    title: "Objection Response Cards | Spartan Coaching",
    description:
      "Ready-to-use response cards for common hospice sales objections.",
  ...
  "/about": {
    ...
    keywords:
      "Nick Lynch, about Spartan Coaching, hospice sales coach, founder",
  },
  "/admin": {
  ...
  "/faq": {
    ...
    keywords:
      "hospice coaching FAQ, Hospice Sales Pro access, evaluation trial, $14.99 week, cancel subscription",
  },
  "/terms": {
    title: "Terms of Service | Spartan Coaching",
    description:
      "Terms governing use of the Spartan Coaching website, Hospice Sales Pro tools, and consulting services.",
  ...
  "/legal": {
    ...
    description:
      "Consulting engagement agreements including BAA, Services Contract, NDA, and related forms.",
    keywords: "legal agreements, consulting contracts",
  },
  "/contract": {
    title: "Services Contract | Spartan Coaching",
    description:
      "Consulting services contract covering scope, fees, confidentiality, and engagement terms.",
    keywords: "services contract, consulting agreement",
  },
  "/nda": {
    title: "Non-Disclosure Agreement | Spartan Coaching",
    description:
      "Mutual NDA protecting confidential business information in consulting engagements.",
    keywords: "NDA, confidentiality agreement",
  },
  "/emr-access": {
    title: "EMR/Data Access Agreement | Spartan Coaching",
    description:
      "Terms for limited consultant access to client systems when required by an engagement.",
    keywords: "EMR access agreement, data access",
  },
  "/conflict-of-interest": {
    title: "Conflict of Interest Disclosure | Spartan Coaching",
    description:
      "How Spartan manages work across multiple hospice organizations and information barriers.",
    keywords: "conflict of interest, consulting ethics",
  },
  "/liability-waiver": {
    title: "Liability Waiver | Spartan Coaching",
    description:
      "Hold harmless terms for consulting services and training activities.",
    keywords: "liability waiver, consulting liability",
  },
  "/testimonial-release": {
    title: "Testimonial Release | Spartan Coaching",
    description:
      "Permission form for client testimonials and case study use in marketing.",
  ...
  "/learn/knowledge-base": {
    ...
    keywords:
      "hospice glossary, eligibility criteria, Medicare hospice benefit",
    noIndex: true,
  },
  "/contact": {
  ...
  "/quiz": {
    ...
    description:
      "Test hospice sales knowledge, eligibility, Medicare benefit, and field terminology.",
  ...
  "/tools/rep-cost-calculator": {
    ...
    description:
      "Calculate the true fully loaded cost of a hospice sales representative.",
  ...
  "/tools/branch-profitability": {
    ...
    description:
      "Model break-even ADC, staffing, and cash runway for a hospice branch.",
  ...
  "/tools/cold-call-script": {
    ...
    description:
      "Build ethical, hospice-specific cold call scripts for referral outreach.",
  ...
  "/tools/weekly-plan-builder": {
    ...
    description:
      "Build a focused weekly sales plan for priority accounts and activities.",

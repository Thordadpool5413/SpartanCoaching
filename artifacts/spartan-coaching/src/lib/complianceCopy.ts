...
export const PRICING_FACTS = {
  ...
  previewNote:
    "Preview tool interfaces free. Live generation requires an active subscription or evaluation.",
  teamNote:
    "Team seats and multi-user access use a 90 day minimum agreement, not the individual weekly plan.",
  evaluationNote:
  ...
  heroLine:
    "Preview free. Elite is recommended at $19.99 per week. Standard is $14.99 per week. Cancel anytime. Team agreements have a 90 day minimum. Consulting is separate.",
...
export const CONSENT_COPY = {
  ...
  marketingOptInHint:
    "Optional. Leaving this unchecked still delivers the resource you asked for.",
  newsletterExplicit:
...
export const TRUST_CENTER_SECTIONS: TrustCenterSection[] = [
  {
    id: "data-handling",
    title: "Data handling",
    body: "Hospice Sales Pro membership tools are built for planning and messaging without patient identifiers. Do not enter PHI in consumer tools. Account data (email, name, organization, billing status) is stored to operate membership, sessions, and support.",
  },
  {
    id: "ai-use",
    title: "How AI is used",
    body: "AI generates drafts for objections, plans, emails, and related field aids when you run a tool. Outputs are educational coaching aids, not clinical, legal, or billing determinations. You remain responsible for adapting language to the relationship and your organization's policies.",
  },
  {
    id: "storage",
    title: "Storage and retention",
    body: "We store account, session, and product-usage data needed to run the service. Clinical vault workflows, when authorized, are designed for ephemeral runs where implemented. Provider-owned library files stay tenant-scoped to your organization.",
  },
  {
    id: "professional-boundaries",
    title: "Professional boundaries",
    body: "This product supports hospice growth work: conversations, territory rhythm, and preparation. It does not replace clinical judgment, eligibility determination, or compliance review. Elite clinical guidance accepts deidentified information only and requires medical director, compliance, or both to approve every output.",
  },
  {
    id: "provider-isolation",
    title: "Provider isolation",
    body: "Organization-owned resources and member work are scoped to your tenant. Other organizations cannot see your provider library or personal saved work through normal product paths.",
  },
  {
    id: "content-review",
    title: "Content review",
    body: "Core field resources and methodology content are curated for hospice sales coaching. Organization libraries may add private materials under your team's ownership and review practices.",
  },
  {
    id: "billing",
    title: "Billing",
    body: "Individual Standard access is $14.99 USD per week and Elite access is $19.99 USD per week. Cancel through the billing provider used to subscribe. Team seats use contracted access. Consulting is billed separately when engaged.",
  },
  {
    id: "security",
    title: "Security practices we claim",
    body: "We use authenticated sessions, role checks, and tenant isolation for membership features. We do not claim third-party security certifications here unless they are formally in place. Report security concerns through published support channels.",
  },
  {
    id: "support",
    title: "Support",
    body: "For access, billing, or product questions, use Account and Contact. Debrief and evaluation conversations can be requested while an evaluation is open.",
  },
];

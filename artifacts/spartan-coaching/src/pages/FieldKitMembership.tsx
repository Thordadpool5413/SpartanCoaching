...
export default function FieldKitMembership() {
  ...
  return (
    <div
      className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 surface-page"
      data-testid="page-hospice-sales-pro"
    >
      <SEO />
      ...
      <div className="text-center max-w-3xl mx-auto mb-10 space-y-4">
        ...
        <h1 className="text-h1 font-display font-black text-foreground">
          ...
          <span className="text-primary">
            Command Center · practice · plans · resources.
          </span>
        </h1>
        <p className="text-body-lg text-muted-foreground leading-relaxed">
          Hospice Sales Pro is what you open on web and iPhone between coaching
          sessions, or on its own: Sales Command Center, objections, role-play,
          playbooks, weekly plans, calculators, and field resources.{" "}
          {PRICING_FACTS.heroLine}
        </p>
        <div
          className="flex flex-col items-center gap-3 pt-2"
          data-testid="membership-hero-cta"
        >
          <SubscribeCTA
        ...
        <details className="rounded-xl border border-border bg-card/50 p-4 sm:p-5">
          ...
          <div className="space-y-6 mt-4">
            {FIELD_KIT_CATEGORIES.filter((cat) =>
              GATED_TOOLS.some((t) => t.category === cat),
            ).map((cat) => {
      ...
      <div className="mb-14">
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-5">
          <Card
            className="order-2 flex flex-col border border-border p-6 bg-card"
          ...
          >
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-5">
              The complete field system for disciplined weekly execution. Cancel
              anytime.
            </p>
            ...
            <div data-testid="button-tier-individual-subscribe">
              <SubscribeCTA
                surface="membership_pricing"
                showHint={false}
                testId="button-tier-individual"
              />
            </div>
          </Card>

          <Card
            className="order-1 flex flex-col border-2 border-primary p-6 bg-primary/[0.04] elite-emphasis"
          ...
          >
            ...
            <h2 className="text-lg font-bold text-foreground mb-1">
              {PRICING_FACTS.eliteProductName}
            </h2>
            <p className="mb-3">
              <span className="text-2xl font-black text-primary">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-5">
              Standard plus private Spartan Coach and deidentified clinical
              guidance. Cancel anytime.
            </p>
            <ul className="space-y-2 mb-6 flex-1">
              {[
                "Everything in Standard",
                "Private voice coaching",
                "Deidentified clinical guidance",
              ].map((f) => (
                <li key={f} className="flex gap-2 text-sm text-foreground">
                  <CheckCircle className="w-4 h-4 text-primary shrink-0 mt-0.5" />
                  <span>{f}</span>
            ...
            <Button asChild className="w-full font-bold">
              <Link
                href="/account?subscribe=1&plan=elite_weekly"
          ...
          <Card
            className="order-3 flex flex-col border border-border p-6 bg-card"
          ...
          >
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-5">
              Multi-seat organization with admin controls and a 90 day minimum
              agreement.
            </p>
            <ul className="space-y-2 mb-6 flex-1">
              {TIER_TEAM_FEATURES.slice(0, 4).map((f) => (
                <li key={f} className="flex gap-2 text-sm text-foreground">
                  <CheckCircle className="w-4 h-4 text-primary shrink-0 mt-0.5" />
                  <span>{f}</span>
                </li>
          ...
          <Card
            className="flex flex-col border border-border p-6 bg-card"
          ...
          >
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-5">
              Hospice Sales Pro seats bundled with leadership coaching and
              workshops.
            </p>
            <ul className="space-y-2 mb-6 flex-1">
            ...
            <Button asChild className="w-full font-bold" variant="outline">
              <Link
                ...
                data-testid="button-tier-enterprise"
              >
      ...
      >
        ...
        <h2 className="text-h3 font-bold text-foreground mb-3">
          ...
          <br />
          <span className="text-primary">
            Standard builds prepared field work. Elite adds private coaching and
            clinical guidance.
          </span>
        </h2>
        <p className="text-muted-foreground leading-relaxed mb-4">
          The Objection Handler gives you the response before you walk into the
          room. Weekly Plan Builder makes Monday intentional. Command Center
          turns every visit into a continuous, coachable account workflow, not
          ten random tabs.
        </p>
        <p className="text-sm text-muted-foreground leading-relaxed">
          Preview tools free. Subscribe to generate, save, and run live. Cancel
          anytime from Account, access continues through the period you already
          paid for.
        </p>
        <div
          className="mt-6 flex justify-center"
          data-testid="membership-roi-subscribe"
        >
          <SubscribeCTA
            surface="membership_pricing"
            showPreview
            showHint={false}
            testId="membership-why-cta"
          />
        </div>
      </div>
      ...
      <Card className="border border-border bg-card p-8 text-center space-y-4 max-w-3xl mx-auto mb-10">
        ...
        <ol className="text-left text-sm text-muted-foreground space-y-2 max-w-xl mx-auto list-decimal list-inside">
          <li>
            <strong className="text-foreground">Preview free</strong>, open any
            tool UI on the Tools page without paying.
          </li>
          <li>
            <strong className="text-foreground">Create your account</strong>,
            two minutes, no admin approval for individual seats.
          </li>
          <li>
            <strong className="text-foreground">
              Choose Standard or Elite
            </strong>{" "}
            from Account. Standard is {PRICING_FACTS.individualWeeklyLabel}.
            Elite is {PRICING_FACTS.eliteWeeklyLabel}. Cancel anytime.
          </li>
          <li>
            <strong className="text-foreground">Teams / providers:</strong>{" "}
            request team access, seats and weekly per-user rate under a 90 day
            minimum agreement.
          </li>
        </ol>
        ...
        >
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              <strong className="text-foreground">Individual:</strong> Standard
              is ${PRICING_FACTS.individualWeeklyUsd.toFixed(2)} USD per week.
              Elite is ${PRICING_FACTS.eliteWeeklyUsd.toFixed(2)} USD per week.
              Billing continues automatically until you cancel. Access continues
              through the paid period.
            </li>
            <li>
              <strong className="text-foreground">Provider / corporate:</strong>{" "}
              Team agreements have a 90 day minimum. {PRICING_FACTS.teamNote}{" "}
              Seat counts and invoices are managed with Spartan Coaching;
              payment may be Stripe invoice or offline terms as agreed.
            </li>
            <li>{PRICING_FACTS.consultingSeparate}</li>
            <li>
              Failed payments may suspend Hospice Sales Pro access until the
              payment method is updated. No PHI belongs in tools.
            </li>
            <li>
              Full legal terms:{" "}

...
export default function Services() {
  const individualServices = [
    ...
    },
    {
      ...
      problem:
        "You know what to say in theory, but it doesn't land in real conversations. You need live feedback, not more classroom training.",
      solution:
        "Experience coaching where it actually matters, in the field with real referral sources. Watch what works, practice it in live situations, and get immediate correction so you walk away with skills you can repeat in every call.",
      includes: [
      ...
      outcome:
        "See exactly what works in the field and practice it until it is repeatable. When real visits convert at a higher rate, eligible patients get referred instead of waiting.",
    },
    {
      ...
      price: "Custom pricing",
      problem:
        "Your calendar is full but your pipeline isn't moving. You're busy but not productive.",
      solution:
  ...
  const leadershipServices = [
    ...
    },
    {
      ...
      price: "Custom pricing",
      problem:
        "You're not sure where growth will come from. You need a plan that's specific, not aspirational.",
      solution:
  ...
  return (
    <PersuasionShell>
      ...
      <div className="text-center max-w-4xl mx-auto mb-14 sm:mb-20 relative">
        ...
        <p className="text-kicker mb-4 animate-fade-in-up">
          Hospice growth consulting
        </p>
        <h1
          className="text-hero text-foreground mb-6 animate-fade-in-up font-display"
          data-testid="text-services-title"
        >
          Work <span className="text-primary">With Us</span>
        </h1>
        <p
          className="text-body-lg text-muted-foreground mb-4 animate-fade-in-up max-w-2xl mx-auto"
          style={{ animationDelay: "0.1s" }}
        >
          Human coaching, team systems, and leadership rhythms for hospice
          growth, so the right conversations happen when eligible patients need
          care.
        </p>
        <p
          className="text-body text-muted-foreground max-w-3xl mx-auto animate-fade-in-up mb-8"
          style={{ animationDelay: "0.2s" }}
        >
          Every engagement exists because good people still miss referrals
          without structure. We install the coaching and the weekly system, not
          a slide deck you forget on Monday.
        </p>
        <div
      ...
      >
        {[
          ...
          <Card
            key={s.t}
            className="border border-border/80 bg-card p-5 text-left h-full"
          >
      ...
      <div className="grid sm:grid-cols-3 gap-4 max-w-4xl mx-auto mb-16 sm:mb-20">
        {[
          {
            t: "Diagnose",
            d: "Territory, team, and referral pattern, honest read, no fluff.",
          },
          {
            t: "Install",
            d: "Coaching, workshops, and a weekly rhythm the team can run without you.",
          },
          {
            t: "Sustain",
            d: "Scorecards, ridealongs, and leadership coaching that hold through busy season.",
          },
        ].map((s) => (
          <Card
            key={s.t}
            className="border border-border/80 bg-card p-5 text-center sm:text-left"
          >
            <p className="text-kicker mb-2 justify-center sm:justify-start">
              {s.t}
            </p>
            <p className="text-sm text-muted-foreground leading-relaxed">
              {s.d}
      ...
      <div
        id="individual"
        className="space-y-8 md:space-y-12 lg:space-y-16 scroll-mt-24"
      >
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 mb-10">
          ...
          <div>
            <h2 className="text-h2 text-foreground mb-1 font-display tracking-tight">
              For Individual Sales Reps
            </h2>
            <p className="text-body text-muted-foreground">
              Get better at the job you&apos;re doing right now.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-cards">
          {individualServices.map((service, idx) => (
            <Card
              key={idx}
              className="flex flex-col border group relative spacing-card shadow-lg hover-card bg-card dark:border-border border-l-4 border-l-primary"
              data-testid={`card-individual-${idx}`}
            >
              ...
              <div className="relative">
                <Button
                  ...
                  data-testid={`button-get-started-individual-${idx}`}
                >
                  <Link
      ...
      >
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 mt-16 mb-10">
          ...
          <div>
            ...
            <p className="text-body text-muted-foreground">
              Build teams that execute consistently and scale what works.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-cards">
          {leadershipServices.map((service, idx) => (
            <Card
              key={idx}
              className="flex flex-col border group relative spacing-card shadow-lg hover-card bg-card dark:border-border border-l-4 border-l-primary"
              data-testid={`card-leadership-${idx}`}
            >
              <div className="absolute inset-0 bg-spartan-gradient-subtle opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
              <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-radial from-red-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700 blur-2xl"></div>
              <div className="flex-1 relative">
              ...
              <div className="relative">
                <Button
                  ...
                  asChild
                  className="w-full font-bold"
                  data-testid={`button-get-started-leadership-${idx}`}
                >
                  <Link
                    href={`/contact?service=${encodeURIComponent(service.title)}`}
                  >
      ...
      >
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 mt-16 mb-10">
          ...
          <div>
            <h2 className="text-h2 text-foreground mb-1">
              For Corporate Hospice Providers
            </h2>
            <p className="text-body text-muted-foreground">
              Scale execution across markets and make growth predictable.
            </p>
          </div>
        </div>

        <Card
          className="flex items-center gap-4 p-4 border-2 border-primary/20 bg-primary/5"
          data-testid="card-corporate-compliance"
        >
          ...
          <Button
            size="sm"
            asChild
            className="font-bold shrink-0 gap-1"
            data-testid="button-request-baa-services"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-cards">
          {corporateServices.map((service, idx) => (
            <Card
              key={idx}
              className="flex flex-col border-2 group relative spacing-card shadow-lg"
              data-testid={`card-corporate-${idx}`}
            >
              <div className="absolute inset-0 bg-spartan-gradient-subtle opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
              <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-radial from-red-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700 blur-2xl"></div>
              <div className="flex-1 relative">
              ...
              <div className="relative">
                <Button
                  ...
                  asChild
                  className="w-full font-bold"
                  data-testid={`button-get-started-corporate-${idx}`}
                >
                  <Link
                    href={`/contact?service=${encodeURIComponent(service.title)}`}
                  >
      ...
      >
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 mt-16 mb-10">
          ...
          <div>
            ...
            <p className="text-body text-muted-foreground">
              Custom-built tools designed specifically for hospice providers.
            </p>
          </div>
        </div>
        ...
        <div className="bg-accent/20 rounded-xl p-5 border border-border mb-2">
          <p className="text-sm text-muted-foreground leading-relaxed">
            Off-the-shelf software is built for generic sales teams. Hospice
            operations have specific workflows, compliance requirements, and
            relationship dynamics that generic tools don't account for. These
            engagements deliver purpose-built technology that fits your
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-cards">
          {techServices.map((service, idx) => (
            <Card
              key={idx}
              className="flex flex-col border-2 group relative spacing-card shadow-lg"
              data-testid={`card-technology-${idx}`}
            >
              <div className="absolute inset-0 bg-spartan-gradient-subtle opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
              <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-radial from-red-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700 blur-2xl"></div>
              <div className="flex-1 relative">
              ...
              <div className="relative">
                <Button
                  ...
                  asChild
                  className="w-full font-bold"
                  data-testid={`button-get-started-technology-${idx}`}
                >
                  <Link
                    href={`/contact?service=${encodeURIComponent(service.title)}`}
                  >
      ...
      <div className="surface-band rounded-3xl p-10 md:p-16 text-center mt-16 text-foreground border border-border">
        ...
        <p className="text-body-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-8">
          Every coaching session, every field ride, every team workshop exists
          because eligible patients are not getting referred. Not because
          hospice is the wrong answer. Because the person who should have had
          that conversation was not prepared to have it. Spartan Coaching exists
          to fix that, one rep, one team, one market at a time.
        </p>
      ...
      <div className="mt-16 sm:mt-20">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 mb-10">
          ...
          <div>
            ...
            <p className="text-body text-muted-foreground">
              Four steps from first contact to weekly coaching.
            </p>
          </div>
        </div>
          ...
          {[
            {
              ...
              title: "Reach out",
              description:
                "Tell us about your role, your challenges, and what you want to improve.",
            },
            {
              step: 2,
              title: "Initial consult",
              description:
                "We review your situation and schedule a conversation to discuss fit.",
            },
            {
              step: 3,
              title: "Coaching plan",
              description:
                "We build a plan with clear deliverables, timeline, and success metrics.",
            },
            {
              step: 4,
              title: "Execute and refine",
              description:
                "Weekly coaching begins. We track progress, adjust, and build consistency.",
            },
          ].map((item) => (
            <Card
              key={item.step}
              className="spacing-card border-2 relative"
      ...
      <div className="mt-16 sm:mt-20">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 mb-10">
          ...
          <div>
            ...
            <p className="text-body text-muted-foreground">
              Answers to the questions we hear most before getting started.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-3xl">
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem
              ...
              data-testid="faq-engagement-length"
            >
              <AccordionTrigger className="text-left text-foreground font-semibold">
                How long is a typical engagement?
              </AccordionTrigger>
              <AccordionContent className="text-muted-foreground leading-relaxed">
                Engagements are flexible. Some clients do a focused 4 to 8 week
                sprint. Others maintain ongoing coaching. We recommend a
                timeline during your initial consult based on your goals.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="switch-types" data-testid="faq-switch-types">
              ...
              <AccordionContent className="text-muted-foreground leading-relaxed">
                Yes. Many clients start with individual coaching and expand to
                team training as they see results. We can adjust scope as your
                needs evolve.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem
              value="not-right-fit"
              data-testid="faq-not-right-fit"
            >
              <AccordionTrigger className="text-left text-foreground font-semibold">
                What if coaching is not the right fit?
              </AccordionTrigger>
              <AccordionContent className="text-muted-foreground leading-relaxed">
                We will tell you during the consult. If your challenge is better
                solved by a different approach, we will say so. No pressure, no
                wasted time.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="outside-us" data-testid="faq-outside-us">
              ...
              <AccordionContent className="text-muted-foreground leading-relaxed">
                Currently our coaching and consulting services focus on the US
                hospice market and Medicare regulations.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem
              value="time-commitment"
              data-testid="faq-time-commitment"
            >
              <AccordionTrigger className="text-left text-foreground font-semibold">
                What is the time commitment?
              </AccordionTrigger>
              <AccordionContent className="text-muted-foreground leading-relaxed">
                Plan for 2 to 3 hours per week, including prep work, the
                coaching session, and post-session execution. The system is
                designed to fit into a working week, not replace it.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
      ...
      <div className="surface-band rounded-3xl p-10 md:p-16 text-center mt-16 text-foreground border border-border">
        ...
        <p className="text-body-lg text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          Let's talk about what is not working and build a plan that fixes it.
        </p>
        <Button
          size="lg"
          asChild
          className="font-bold shadow-lg touch-manipulation group px-10 bg-red-600 text-white border-red-600"

...
export default function Disclaimer() {
  return (
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <BackButton />
      <FadeIn>
        <h1 className="text-h1 text-foreground mb-4" data-testid="text-disclaimer-title"><AccentText>Disclaimer</AccentText></h1>
        ...
        <div className="space-y-8">
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>General Disclaimer</AccentText></h2>
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>Not Medical Advice</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>Not Legal Advice</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>No Guaranteed Results</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>Professional Judgment</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>AI-Generated Content</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>Earnings and Results</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>External Links</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>Changes to This Disclaimer</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">

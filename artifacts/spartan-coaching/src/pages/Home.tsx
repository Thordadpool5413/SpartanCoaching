  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative min-h-[50vh] sm:min-h-[60vh] md:h-[92vh] flex items-center justify-center overflow-hidden bg-gray-950">
        ...
        {/* Spartan crest — brand anchor, behind all text */}
        <div className="absolute inset-0 z-[3] flex items-center justify-end pointer-events-none overflow-hidden">
          {/* Soft red glow behind the crest */}
          <motion.div
            className="absolute right-[-5%] w-[55vw] h-[55vw] max-w-[680px] max-h-[680px] rounded-full bg-[#e8291e] blur-[100px]"
            initial={{ opacity: 0 }}
          ...
          <motion.img
            ...
            alt=""
            aria-hidden="true"
            className="w-[55vw] max-w-[640px] h-auto object-contain mr-[-8%] opacity-0"

...
import { Bell, Clock, Mail, Copy, Loader2, Send, Download, X } from "lucide-react";
...
function ReminderPicker({
  ...
  const handleSchedule = async (minutes: number, presetLabel: string) => {
    ...
    const title = emailTitle || "Follow-Up Reminder";
              ...
              {generatedTemplate ? (
                <div className="space-y-4">
                  ...
                  <ReminderPicker
                    emailTitle={
                      recipientName
                        ? `Follow up with ${recipientName}`
                        : "Follow-Up Reminder"
                    }
                    contact={recipientName}
                    onScheduled={reloadReminders}
                  />

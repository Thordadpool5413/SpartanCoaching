...
export default function PrivacyPolicy() {
  return (
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <BackButton />
      <FadeIn>
        <h1 className="text-h1 text-foreground mb-4" data-testid="text-privacy-title"><AccentText>Privacy Policy</AccentText></h1>
        ...
        <div className="space-y-8">
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>1. Information We Collect</AccentText></h2>
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>2. How We Use Your Information</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>3. Information Sharing</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>4. Cookies and Tracking</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>5. Data Security</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>6. Your Rights</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>7. Children's Privacy</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>8. Hospice Sales Pro Accounts &amp; Access Requests</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed mb-4">
              When you request Hospice Sales Pro evaluation access or create a client account, we collect information needed to review and operate that relationship. This typically includes your name, work email, organization, role, seat type (individual or company), and notes you provide about why you are requesting access.
            </p>
            <p className="text-body text-muted-foreground leading-relaxed mb-4">
              Approved accounts use session-based sign-in. We store account credentials securely (password hashes — never plain-text passwords), session tokens, subscription or trial status, optional organization membership, and light product usage needed to support coaching and access control (for example, onboarding checklist progress). Evaluation access starts by request and approval. Individuals may then subscribe for weekly Hospice Sales Pro through our secure Stripe checkout; we store Stripe customer and subscription identifiers needed to manage billing, cancelation, and access — not full card numbers (those stay with Stripe). Team seats are activated under contract.
            </p>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>9. Changes to This Policy</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3"><AccentText>10. Contact Us</AccentText></h2>
            <p className="text-body text-muted-foreground leading-relaxed">

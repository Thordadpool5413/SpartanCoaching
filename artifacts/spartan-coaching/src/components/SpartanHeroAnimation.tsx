  ...
  return (
    <motion.div className="absolute inset-0 flex flex-col items-center justify-center z-10"
      ...
      <div className="text-center px-8">
        <motion.h2 className="text-[2.5cqi] text-foreground/70 tracking-[0.45em] uppercase font-medium mb-[4cqh]"
        ...
        <div className="overflow-hidden">
          <motion.div className="text-[9cqi] text-foreground font-display font-black uppercase tracking-tight leading-[0.9]"
        ...
        <div className="overflow-hidden">
          <motion.div className="text-[9cqi] text-primary font-display font-black uppercase tracking-tight leading-[0.9]"
            initial={{ y: "110%" }} animate={phase >= 2 ? { y: 0 } : { y: "110%" }}
            transition={{ type: "spring", stiffness: 900, damping: 38, delay: 0.04 }}>
            MYSTERY
          </motion.div>
        </div>
        <motion.div className="h-[3px] bg-primary mt-7 origin-left"
          initial={{ scaleX: 0 }}
    ...
    <motion.div className="absolute inset-0 flex items-center justify-center z-10"
      ...
      {[0, 1, 2].map((i) => (
        <motion.div key={`shock-${shockKey}-${i}`}
          ...
          initial={{ width: "5cqi", height: "5cqi", opacity: 0.9 }}
          animate={{ width: "90cqi", height: "90cqi", opacity: 0 }}
          transition={{ duration: 0.7 + i * 0.18, delay: i * 0.12, ease: "easeOut" }} />
      ))}
      <motion.div className="text-[16cqi] font-display font-black uppercase leading-none absolute select-none"
       ...
       <motion.div className="text-[20cqi] font-display font-black uppercase text-primary leading-none absolute mix-blend-screen"
       ...
       <motion.div className="absolute bottom-16 left-16 h-[3px] bg-primary origin-left"
        style={{ width: "40cqi" }}
        initial={{ scaleX: 0 }}
        animate={phase >= 3 ? { scaleX: 1 } : { scaleX: 0 }}
...
function ScanLine({ trigger }: { trigger: number }) {
  return (
    <motion.div key={trigger}
       className="absolute left-0 right-0 h-[1px] bg-foreground pointer-events-none z-30"
      style={{ top: "50%" }}
...
function Scene3_Kinetic() {
  ...
  return (
    <motion.div className="absolute inset-0 z-10"
      ...
      <div className="absolute inset-0 flex flex-col justify-center px-[8cqi]">
        <div className="overflow-hidden mb-3">
          <motion.div className="text-[7.5cqi] font-display font-black uppercase text-foreground leading-none"
        ...
        <div className="overflow-hidden mb-3">
           <motion.div className="text-[7.5cqi] font-display font-black uppercase text-primary leading-none"
            initial={{ y: "110%" }} animate={phase >= 2 ? { y: 0 } : { y: "110%" }}
            transition={{ type: "spring", stiffness: 700, damping: 32 }}>
        ...
        <motion.div className="absolute inset-0 bg-primary z-20 pointer-events-none"
          initial={{ opacity: 0 }}
      ...
      {sparks.map(({ tx, ty, size }, i) => (
        <motion.div key={i}
          ...
          initial={{ x: 0, y: 0, opacity: 0, scale: 1 }}
            animate={active ? { x: `${tx}cqh`, y: `${ty}cqh`, opacity: [0, 1, 0], scale: [1, 1.5, 0] } : { opacity: 0 }}
  ...
  return (
    <motion.div className="absolute inset-0 flex items-center justify-center z-20 bg-black/50"
      ...
      <div className="relative w-full h-full flex items-center justify-center">
        <motion.div className="absolute w-[55cqh] h-[55cqh] rounded-full bg-primary blur-[80px]"
          initial={{ opacity: 0, scale: 0 }}
          animate={phase >= 1 ? { opacity: 0.55, scale: 1 } : { opacity: 0, scale: 0 }}
          transition={{ duration: 0.6, ease: "easeOut" }} />
        <motion.div className="absolute w-[80cqh] h-[80cqh] rounded-full bg-primary blur-[120px]"
          initial={{ opacity: 0 }}
        ...
        <motion.img src={spartanStamp} alt="Spartan Crest"
          className="w-[58cqh] h-[58cqh] max-w-[62cqi] max-h-[62cqi] object-contain relative z-10"
        ...
        <motion.div className="absolute text-[18cqi] font-display font-black text-foreground/[0.035] uppercase whitespace-nowrap pointer-events-none"
        ...
        <motion.div className="absolute bottom-12 flex flex-col items-center px-8"
          ...
          <h2 className="text-[4cqi] font-display uppercase tracking-widest text-primary font-black"><AccentText>DOMINATE YOUR MARKET</AccentText></h2>
          <motion.div className="h-[3px] bg-primary w-full origin-left mt-2"
            initial={{ scaleX: 0 }}
...
function Scene5_Outro() {
  ...
  return (
    <motion.div className="absolute inset-0 flex flex-col items-center justify-center z-30 bg-background"
      ...
      <motion.div className="absolute inset-0 bg-primary pointer-events-none"
        initial={{ opacity: 0.4 }} animate={{ opacity: 0 }}
        transition={{ duration: 0.5, ease: "easeOut" }} />
      <div className="relative flex flex-col items-center">
        <motion.img src={spartanStamp} alt="Spartan Coaching"
          className="w-[30cqh] h-[30cqh] max-w-[34cqi] max-h-[34cqi] object-contain mb-[5cqh] relative z-10"
        ...
        <motion.div className="flex flex-col items-center"
          ...
          <div className="text-[4.5cqi] font-display font-black uppercase tracking-[0.22em] text-foreground leading-none">
            SPARTAN COACHING
          </div>
          <motion.div className="h-[3px] bg-primary w-full origin-left mt-4 mb-4"
            initial={{ scaleX: 0 }}
            animate={phase >= 2 ? { scaleX: 1 } : { scaleX: 0 }}
            transition={{ duration: 0.22, ease: [0.22, 1, 0.36, 1] }} />
          <motion.p className="text-[1.6cqi] font-body text-foreground/70 tracking-[0.24em] uppercase"
            initial={{ opacity: 0 }}
  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden bg-background" data-testid="hero-animation">
      ...
      <div className="absolute inset-0 z-0">
        <motion.div
          className="absolute w-[70cqi] h-[70cqi] rounded-full blur-[90px]"
        ...
        />
        <motion.div
          className="absolute w-[50cqi] h-[50cqi] rounded-full blur-[70px] right-0 bottom-0"
      ...
      <motion.div
        ...
        className="absolute inset-0 z-40 pointer-events-none bg-primary"
        initial={{ opacity: 0.6 }}
        animate={{ opacity: 0 }}
      ...
      <motion.div
        ...
        className="absolute left-0 right-0 h-[2px] bg-foreground z-[41] pointer-events-none"
        style={{ top: 0 }}

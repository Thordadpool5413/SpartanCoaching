    ...
    try {
      ...
      if (response.status === 401 || response.status === 403) {
        const aiMessage: ChatMessage = {
          role: "model",
          content:
            "The AI coach is part of Spartan Membership. Create an account and subscribe ($14.99/week), sign in if you already have access, or book a strategy call for team seats.",
          timestamp: Date.now(),
        };

...
- **Homepage Conversion Structure**: Hero with "Apply Now" primary CTA, trust stack with credibility bullets, problem/promise section, "What You Get" deliverables list, "Hospice Realities We Train For" bullets, "How It Works" numbered steps with timeline, results/proof placeholders, compliance/ethics block (5 required points), "Who This Is For / Not For" section, tools showcase, "Why Spartan" credibility section. Primary CTA is "Apply Now" throughout. Spartan is a consulting business, AI is a supporting tool, not the brand identity.
- **Legal Documents Suite**: Complete set of digitally signable legal agreements accessible via /legal landing page, with individual pages at /baa, /contract, /nda, /emr-access, /conflict-of-interest, /liability-waiver, /testimonial-release. Each uses the reusable AgreementSignatureForm component with name, title, organization, email, date, and checkbox. Signed agreements stored in signedAgreements database table and emailed to both the signer and nicholas.lynch@spartan-coaching-schools.org via Resend.
...
- **Services "Work With Us" Page**: Restructured with application process steps, buying-decision FAQs, and "Apply Now" CTAs throughout. Organized by Individual Reps, Sales Leadership, and Corporate Providers.
- **Master Prompt Compliance**: All copy follows master prompt rules: no dashes of any kind, "Apply" as primary CTA, compliance posture visible on homepage and dedicated page, practical/grounded tone, no hype or guarantees.
...
2. `smoke-parity` — Learn feeds, field-kit unauth 401/403, **org admin unauth gates** (stable: members/usage/invites hard-fail; profile/audit/structure/offboard soft-WARN on 404 until redeploy; `STRICT_ORG_GATES=1` to hard-fail soft routes)

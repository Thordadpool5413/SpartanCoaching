    ...
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <FadeIn>
        ...
        <div className="space-y-8">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3">5. AI Tools Disclaimer</h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3">6. User Submissions</h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3">7. Third-Party Links</h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3">8. Limitation of Liability</h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3">9. Indemnification</h2>
            <p className="text-body text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-h2 text-foreground mb-3">10. Changes to Terms</h2>
            <p className="text-body text-muted-foreground leading-relaxed">
